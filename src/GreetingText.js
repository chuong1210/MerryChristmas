...
class GreetingText {
    ...
    createGreetingTexts(font) {
        ...
        text1Mesh.position.set(0, 5.5, -2.5); // Tăng từ 4.5 lên 5.5
        ...
        text2Mesh.position.set(0, 4.6, -2.5); // Tăng từ 3.6 lên 4.6
        ...
        text3Mesh.position.set(0, 3.8, -2.5); // Tăng từ 2.8 lên 3.8
        ...
        text4Mesh.position.set(0, 3.45, -2.5); // Tăng từ 2.45 lên 3.45
        ...
        text5Mesh.position.set(0, 3.0, -2.5); // Tăng từ 2.0 lên 3.0
        ...
        text6Mesh.position.set(0, 2.7, -2.5); // Tăng từ 1.7 lên 2.7
        ...
        text7Mesh.position.set(0, 2.4, -2.5); // Tăng từ 1.4 lên 2.4
    ...
    addTextLights() {
        ...
        light1.position.set(0, 4.5, -1); // Tăng từ 3.5 lên 4.5
        this.scene.add(light1);

        const light2 = new THREE.PointLight(0xffffff, 0.6, 5);
        light2.position.set(2, 3.5, -1.5); // Tăng từ 2.5 lên 3.5
        this.scene.add(light2);

        const light3 = new THREE.PointLight(0xffffff, 0.6, 5);
        light3.position.set(-2, 3.5, -1.5); // Tăng từ 2.5 lên 3.5
